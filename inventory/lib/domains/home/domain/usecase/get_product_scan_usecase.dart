...
class GetProductScanUsecase extends UseCase<OperationResponseDto, DetailBarcodeRequestDto> {
  final HomeRepository homeRepository;

  GetProductScanUsecase({required this.homeRepository});

  @override
  Future<Either<FailureResponse, OperationResponseDto>> call(
          DetailBarcodeRequestDto params) async => await homeRepository.getProductScan(detailBarcodeRequestDto: params);
}